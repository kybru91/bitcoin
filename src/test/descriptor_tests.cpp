...
constexpr int MULTIPATH_FIRST = 1 << 8; // Must be a multipath descriptor. Use the first descriptor in the pair (the receive descriptor).
constexpr int MULTIPATH_SECOND = 1 << 9; // Must be a multipath descriptor. Use the second descriptor in the pair (the change descriptor).
