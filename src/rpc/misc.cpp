    ...
    return RPCHelpMan{"getdescriptorinfo",
            ...
            RPCResult{
                RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR, "descriptor_change", /*optional=*/ true, "The change descriptor in canonical form, without private keys. Only if the provided descriptor specifies derivation paths for both receiving and change."},
