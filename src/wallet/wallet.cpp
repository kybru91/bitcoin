        ...
        bool sign)
{
    ...
    // Choose coins to use
    if (!SelectCoins(vAvailableCoins, selection_target, coin_control, coin_selection_params, selection))
    {
    ...
    const CAmount change_and_fee = selection.GetSelectedValue() - recipients_sum;
