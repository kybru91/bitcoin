    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
      ...
      // test randomness
      {
          ...
          for (int i = 0; i < RUN_TESTS; i++) {
            ...
            BOOST_CHECK(KnapsackSolver(50 * COIN, GroupCoins(vCoins), setCoinsRet2, nValueRet, knapsack_result));
            ...
            for (int j = 0; j < RANDOM_REPEATS; j++)
            {
                ...
                BOOST_CHECK(KnapsackSolver(COIN, GroupCoins(vCoins), setCoinsRet2, nValueRet, knapsack_result));
