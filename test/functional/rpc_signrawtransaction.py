...
from test_framework.key import bytes_to_wif, ECKey
...
class SignRawTransactionsTest(BitcoinTestFramework):
    ...
    def witness_script_test(self):
        ...
        spending_tx = self.nodes[0].createrawtransaction([unspent_output], {self.nodes[1].get_wallet_rpc('').getnewaddress(): Decimal("49.998")})
